  ...
  find(input) {
    ...
    */
    ...
    const mainExtractionAlgorithm = (
      ...
      characterIndex, // index of the chunk's first character in the whole text (ie. number of chars before)
      sentenceIndex,  // index of the chunk in the whole text (ie. number of chunks before)
      ...
      for (let n = 1; n <= maxLength; n++) {
        ...
        let localPosition = characterIndex
